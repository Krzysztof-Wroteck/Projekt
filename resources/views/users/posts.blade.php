...
<x-app-layout>
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center justify-between">
                    ...
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 mx-8"> Dodaj nowy post
                </a>
                </div>
    ...
    <div class="fixed-width bg-gray-200 dark:bg-gray-700 rounded-md p-4 mb-4">
        <div class="flex justify-between items-center mb-2">
            ...
            <div class="text-gray-700 dark:text-gray-300 opacity-30"> Data dodania {{ $post->created_at }} @if($post->created_at != $post->updated_at)
                        (edited)
                    @endif
                </div>
