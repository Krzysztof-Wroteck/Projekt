<x-app-layout>
    ...
    <span class="font-semibold text-lg text-gray-800 dark:text-gray-200">{{ $posts->first()->user->name }}</span>
    <br>
    <span class="text-gray-500">Obserwowani</span>
  
         <span class="text-gray-500">Obserowany przez</span>
    <br>
    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2">
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    @if($posts->isEmpty())
                        <div class="text-center text-gray-600">Nie masz jeszcze żadnych postów.</div>
                    @else
